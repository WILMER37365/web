                ...
                <div class="col-md-12">
                    <div class="card card-outline card-success">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo APP_URL;?>/app/controllers/usuarios/update_personal.php" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $nombres;?>" name="nombre_usuario" class="form-control" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $apellidos;?>" name="apellido_usuario" class="form-control" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="<?php echo $usuar;?>" name="alias" class="form-control" disabled>
                                                </div>
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <a href="<?php echo APP_URL;?>/admin" class="btn btn-secondary">Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </form>
