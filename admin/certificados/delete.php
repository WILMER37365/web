    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                ...
                <h1>ELIMINAR PRODUCTO: <?php echo $producto; ?></h1>
                ...
                <div class="col-md-12">
                    <div class="card card-outline card-danger">
                        ...
                        <div class="card-body">
                            ...
                            <form action="<?php echo APP_URL; ?>/app/controllers/certificados/delete.php" method="post"
                                  enctype="multipart/form-data" id="miFormulario2<?php echo $id_certificado; ?>">
                                <div class="row">
                                    <!-- /.NOMBRE DE PRODUCTO -->
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="composicion_cert"
                                                   value="<?php echo $composicion; ?>"
                                                   class="form-control" required disabled>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" name="fecha_emision"
                                                           value="<?php echo $fecha_emision; ?>" class="form-control"
                                                           required disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="vigencia" class="form-control" disabled>
                                                        ...
                                                        <option value="1" <?php if ($vigencia == '1') echo 'selected'; ?>>
                                                            Vigente
                                                        </option>
                                                        <option value="2" <?php if ($vigencia == '2') echo 'selected'; ?>>
                                                            Proximo a Vencer
                                                        </option>
                                                        <option value="3" <?php if ($vigencia == '3') echo 'selected'; ?>>
                                                            Vencido
                                                        </option>
                                                    </select>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="numero_registro"
                                                           value="<?php echo $numero_registro_sanitario; ?>"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="codigo_liname"
                                                           value="<?php echo $codigo_liname; ?>" class="form-control"
                                                           disabled>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select name="ficha_tecnica" class="form-control" disabled>
                                                        ...
                                                        <option value="habilitado" <?php if ($ficha_tecnica == "habilitado") echo 'selected'; ?>>
                                                            Habilitado
                                                        </option>
                                                        <option value="deshabilitado" <?php if ($ficha_tecnica == "deshabilitado") echo 'selected'; ?>>
                                                            Deshabilitado
                                                        </option>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <select name="estado_cert" class="form-control" disabled>
                                                    ...
                                                    <option value="1" <?php if ($estado_cert == '1') echo 'selected'; ?>>
                                                        Activo
                                                    </option>
                                                    <option value="0" <?php if ($estado_cert == '0') echo 'selected'; ?>>
                                                        Inactivo
                                                    </option>
                                                </select>
                                            </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="documento_cert" value="<?php echo $documento; ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-danger" onclick="preguntar(<?php echo $id_certificado; ?>)">Eliminar</button>
